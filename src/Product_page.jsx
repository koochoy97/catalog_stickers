...
export function ProductPage() {
  ...
  return (
    ...
    >
      ...
      <div className="main flex flex-col justify-start items-start w-full">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="pricing_container flex justify-between items-center w-full fixed bottom-0 left-0 bg-white px-5 py-8 rounded-t-3xl border-t">
