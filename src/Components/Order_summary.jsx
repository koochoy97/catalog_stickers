        ...
        cartDetails?.map((item) => {
          ...
          return (
            <div className="item flex items-start gap-3 w-full" key={item.id}>
              <img
                src={`https://mtb.pockethost.io/api/files/sticker_products/${item.product.id}/${item.product.principal_image}`}
              ...
              <div className="flex flex-1 items-start justify-between">
                ...
                <div className="flex flex-col items-start w-full">
                  <p className="font-semibold text-sm">{item.product.nombre}</p>
                  <p
